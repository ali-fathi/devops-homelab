...
| 2026-08-14 | Disposable NetworkPolicy enforcement probe | HIGH | Ingress deny NetworkPolicy remained reachable after 60 seconds | Isolated namespace `networkpolicy-probe-20260814151536-16664` (local evidence) | Fix now | Ali | Baseline Pod-to-Pod HTTP was reachable, but deny ingress never blocked it. Do not deploy default-deny or rely on existing NetworkPolicies; identify and repair active CNI/NetworkPolicy enforcement, then rerun the isolated `reachable -> denied -> reachable` proof. Review by 2026-08-21. |
| 2026-08-14 | Disposable NetworkPolicy enforcement probe | MEDIUM | Isolated probe namespace deletion did not finish within its original 60-second cleanup timeout | Isolated namespace `networkpolicy-probe-20260814151536-16664` | Needs investigation | Ali | The delete request was issued. Inspect namespace phase, finalizers, remaining test resources, and events; do not force-remove finalizers before determining the cause. Script cleanup timeout was separated and increased to 180 seconds. Review by 2026-08-21. |
